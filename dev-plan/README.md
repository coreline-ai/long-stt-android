...
| 문서 | 상태 | 범위 |
|---|---|---|
| [`implement_20260819_160712.md`](implement_20260819_160712.md) | **소스 구현·자동 검증 완료 / OAuth 운영 설정·실기기 검증 대기** | 개인 Google Drive 직접 업로드, 선택적 자동 업로드, WorkManager 복구, Drive 앱 공유 폴백 |

## 최신 완료 기준

| 문서 | 완료 범위 |
|---|---|
| [`implement_20260816_090437.md`](implement_20260816_090437.md) | 전사 기반 AI 대화·근거 viewer 디자인 정합성, 공용 하단 내비게이션, system inset |
